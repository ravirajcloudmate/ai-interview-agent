-- Interview sessions table for link-based interviews
...
-- Interview messages (for real-time chat/transcript)
...
-- Allow reading interview sessions by session token (for candidates)
